...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            item_number = input(f"Enter item number: ")  
...
#                     # Tell the customer that their input isn't valid
                    ...
                    print("Please select more then 0 items. Please select an item number.")
...
total = sum([float(x["Price"]) * float(x["Quantity"]) for x in order_list])
